...
!function (global) {
    ...
    return x = {
      ...
      init: function (e, t, n, r) {
        ...
        E[this.map.id] = this, this.enabled = !0, this.enabling = !0, each(this.depMaps, bind(this, function (e, t) {
          ...
          n = e.id, r = C[n], hasProp(x, n) || !r || r.enabled || b.enable(e, this)
  ...
  function E(e, t, n, r, i) {
    for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2)"margin" === n && (a += Z.css(e, n + wt[o], !0, i)), r ? ("content" === n && (a -= Z.css(e, "padding" + wt[o], !0, i)), "margin" !== n && (a -= Z.css(e, "border" + wt[o] + "Width", !0, i))) : (a += Z.css(e, "padding" + wt[o], !0, i), "padding" !== n && (a += Z.css(e, "border" + wt[o] + "Width", !0, i)));
    return a
  }
  ...
  function T(e, t, n) {
    ...
    if (0 >= i || null == i) {
      if (i = x(e, t, o), (0 > i || null == i) && (i = e.style[t]), Ut.test(i))return i;
  ...
  var it = function (e) {
    ...
    function $(e) {
      ...
      }]; i > s; s++)if (n = w.relative[e[s].type])c = [d(h(c), n)]; else {
    ...
    function y(e, n) {
      var i = n.length > 0, o = e.length > 0, a = function (r, a, s, u, l) {
        var c, p, f, d = 0, h = "0", g = r && [], v = [], $ = D, y = r || o && w.find.TAG("*", l), b = V += null == $ ? 1 : Math.random() || .1, x = y.length;
        for (l && (D = a !== N && a); h !== x && null != (c = y[h]); h++) {
          if (o && c) {
    ...
    var b, x, w, k, C, E, T, S, D, A, M, O, N, q, P, j, R, H, L, F = "sizzle" + -new Date, I = e.document, V = 0, U = 0, _ = n(), B = n(), W = n(), z = function (e, t) {
      return e === t && (M = !0), 0
    ...
    }, gt = /^(?:input|select|textarea|button)$/i, mt = /^h\d$/i, vt = /^[^{]+\{\s*\[native \w/, $t = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, yt = /[+~]/, bt = /'|\\/g, xt = new RegExp("\\\\([\\da-f]{1,6}" + rt + "?|(" + rt + ")|.)", "ig"), wt = function (e, t, n) {
      var r = "0x" + t - 65536;
    ...
    x = t.support = {}, C = t.isXML = function (e) {
      ...
      return n !== N && 9 === n.nodeType && n.documentElement ? (N = n, q = n.documentElement, P = !C(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function () {
        O()
        ...
        }, R = [], j = [], (x.qsa = vt.test(n.querySelectorAll)) && (i(function (e) {
      ...
      })), (x.matchesSelector = vt.test(H = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector)) && i(function (e) {
        x.disconnectedMatch = H.call(e, "div"), H.call(e, "[s!='']:x"), R.push("!=", st)
      }), j = j.length && new RegExp(j.join("|")), R = R.length && new RegExp(R.join("|")), t = vt.test(q.compareDocumentPosition), L = t || vt.test(q.contains) ? function (e, t) {
        ...
        return r ? r : (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & r || !x.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === I && L(I, e) ? -1 : t === n || t.ownerDocument === I && L(I, t) ? 1 : A ? tt.call(A, e) - tt.call(A, t) : 0 : 4 & r ? -1 : 1)
      } : function (e, t) {
        if (e === t)return M = !0, 0;
      ...
      if ((e.ownerDocument || e) !== N && O(e), n = n.replace(pt, "='$1']"), !(!x.matchesSelector || !P || R && R.test(n) || j && j.test(n)))try {
        var r = H.call(e, n);
      ...
      var n = w.attrHandle[t.toLowerCase()], r = n && G.call(w.attrHandle, t.toLowerCase()) ? n(e, t, !P) : void 0;
      ...
      pseudos: {
        not: r(function (e) {
          ...
          return dt.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(xt, wt).toLowerCase(), function (t) {
            var n;
    ...
    return p.prototype = w.filters = w.pseudos, w.setFilters = new p, E = t.tokenize = function (e, n) {
      ...
      if (n = n || [], 1 === p.length) {
        if (o = p[0] = p[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && x.getById && 9 === t.nodeType && P && w.relative[o[1].type]) {
          if (t = (w.find.ID(a.matches[0].replace(xt, wt), t) || [])[0], !t)return n;
          l && (t = t.parentNode), e = e.slice(o.shift().value.length)
        }
        for (i = ht.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !w.relative[s = a.type]);)if ((u = w.find[s]) && (r = u(a.matches[0].replace(xt, wt), yt.test(o[0].type) && c(t.parentNode) || t))) {
          if (o.splice(i, 1), e = r.length && f(o), !e)return Z.apply(n, r), n;
          break
        }
      }
      return (l || T(e, p))(r, t, !P, n, yt.test(e) && c(t.parentNode) || t), n
    }, x.sortStable = F.split("").sort(z).join("") === F, x.detectDuplicates = !!M, O(), x.sortDetached = i(function (e) {
  ...
  var xt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, wt = ["Top", "Right", "Bottom", "Left"], kt = function (e, t) {
  ...
  var Mt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ot = /<([\w:]+)/, Nt = /<|&#?\w+;/, qt = /<(?:script|style|link)/i, Pt = /checked\s*(?:[^=]|=\s*.checked.)/i, jt = /^$|\/(?:java|ecma)script/i, Rt = /^true\/(.*)/, Ht = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Lt = {
  ...
  Lt.optgroup = Lt.option, Lt.tbody = Lt.tfoot = Lt.colgroup = Lt.caption = Lt.thead, Lt.th = Lt.td, Z.extend({
    ...
    text: function (e) {
      ...
      return mt(this, function (e) {
        ...
        if ("string" == typeof e && !qt.test(e) && !Lt[(Ot.exec(e) || ["", ""])[1].toLowerCase()]) {
          e = e.replace(Mt, "<$1></$2>");
          try {
      ...
      if (g || l > 1 && "string" == typeof f && !Q.checkClone && Pt.test(f))return this.each(function (n) {
        var r = c.eq(n);
  ...
  var Ft, It = {}, Vt = /^margin/, Ut = new RegExp("^(" + xt + ")(?!px)[a-z%]+$", "i"), _t = function (e) {
  ...
  var Bt = /^(none|table(?!-c[ea]).+)/, Wt = new RegExp("^(" + xt + ")(.*)$", "i"), zt = new RegExp("^([+-])=(" + xt + ")", "i"), Yt = {
    position: "absolute",
    visibility: "hidden",
    display: "block"
  ...
  Z.extend({
    ...
    css: function (e, t, n, r) {
      ...
      return t = Z.cssProps[s] || (Z.cssProps[s] = k(e.style, s)), a = Z.cssHooks[t] || Z.cssHooks[s], a && "get"in a && (i = a.get(e, !0, n)), void 0 === i && (i = x(e, t, r)), "normal" === i && t in Xt && (i = Xt[t]), "" === n || n ? (o = parseFloat(i), n === !0 || Z.isNumeric(o) ? o || 0 : i) : i
    }
    ...
    Z.cssHooks[e + t] = {
      expand: function (n) {
        for (var r = 0, i = {}, o = "string" == typeof n ? n.split(" ") : [n]; 4 > r; r++)i[e + wt[r] + t] = o[r] || o[r - 2] || o[0];
        return i
      }
  ...
  var Qt, Kt, Jt = /^(?:toggle|show|hide)$/, Zt = new RegExp("^(?:([+-])=|)(" + xt + ")([a-z%]*)$", "i"), en = /queueHooks$/, tn = [N], nn = {
    "*": [function (e, t) {
  ...
  var fn, dn, hn = /#.*$/, gn = /([?&])_=[^&]*/, mn = /^(.*?):[ \t]*([^\r\n]*)$/gm, vn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, $n = /^(?:GET|HEAD)$/, yn = /^\/\//, bn = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, xn = {}, wn = {}, kn = "*/".concat("*");
  try {
    dn = location.href
  } catch (Cn) {
  ...
  fn = bn.exec(dn.toLowerCase()) || [], Z.extend({
    ...
    ajax: function (e, t) {
      function n(e, t, n, a) {
        var u, c, v, $, b, w = t;
        2 !== y && (y = 2, s && clearTimeout(s), r = void 0, o = a || "", x.readyState = e > 0 ? 4 : 0, u = e >= 200 && 300 > e || 304 === e, n && ($ = L(p, x, n)), $ = F(p, $, x, u), u ? (p.ifModified && (b = x.getResponseHeader("Last-Modified"), b && (Z.lastModified[i] = b), b = x.getResponseHeader("etag"), b && (Z.etag[i] = b)), 204 === e || "HEAD" === p.type ? w = "nocontent" : 304 === e ? w = "notmodified" : (w = $.state, c = $.data, v = $.error, u = !v)) : (v = w, (e || !w) && (w = "error", 0 > e && (e = 0))), x.status = e, x.statusText = (t || w) + "", u ? h.resolveWith(f, [c, w, x]) : h.rejectWith(f, [x, w, v]), x.statusCode(m), m = void 0, l && d.trigger(u ? "ajaxSuccess" : "ajaxError", [x, p, u ? c : v]), g.fireWith(f, [x, w]), l && (d.trigger("ajaxComplete", [x, p]), --Z.active || Z.event.trigger("ajaxStop")))
      }

      "object" == typeof e && (t = e, e = void 0), t = t || {};
      var r, i, o, a, s, u, l, c, p = Z.ajaxSetup({}, t), f = p.context || p, d = p.context && (f.nodeType || f.jquery) ? Z(f) : Z.event, h = Z.Deferred(), g = Z.Callbacks("once memory"), m = p.statusCode || {}, v = {}, $ = {}, y = 0, b = "canceled", x = {
        readyState: 0,
      ...
      if (h.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, p.url = ((e || p.url || dn) + "").replace(hn, "").replace(yn, fn[1] + "//"), p.type = t.method || t.type || p.method || p.type, p.dataTypes = Z.trim(p.dataType || "*").toLowerCase().match(dt) || [""], null == p.crossDomain && (u = bn.exec(p.url.toLowerCase()), p.crossDomain = !(!u || u[1] === fn[1] && u[2] === fn[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (fn[3] || ("http:" === fn[1] ? "80" : "443")))), p.data && p.processData && "string" != typeof p.data && (p.data = Z.param(p.data, p.traditional)), R(xn, p, t, x), 2 === y)return x;
      l = p.global, l && 0 === Z.active++ && Z.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !$n.test(p.type), i = p.url, p.hasContent || (p.data && (i = p.url += (pn.test(i) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = gn.test(i) ? i.replace(gn, "$1_=" + cn++) : i + (pn.test(i) ? "&" : "?") + "_=" + cn++)), p.ifModified && (Z.lastModified[i] && x.setRequestHeader("If-Modified-Since", Z.lastModified[i]), Z.etag[i] && x.setRequestHeader("If-None-Match", Z.etag[i])), (p.data && p.hasContent && p.contentType !== !1 || t.contentType) && x.setRequestHeader("Content-Type", p.contentType), x.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + kn + "; q=0.01" : "") : p.accepts["*"]);
      for (c in p.headers)x.setRequestHeader(c, p.headers[c]);
      if (p.beforeSend && (p.beforeSend.call(f, x, p) === !1 || 2 === y))return x.abort();
      b = "abort";
      for (c in{success: 1, error: 1, complete: 1})x[c](p[c]);
      if (r = R(wn, p, t, x)) {
        x.readyState = 1, l && d.trigger("ajaxSend", [x, p]), p.async && p.timeout > 0 && (s = setTimeout(function () {
          x.abort("timeout")
        }, p.timeout));
        try {
          y = 1, r.send(v, n)
  ...
  var Mn = 0, On = {}, Nn = {0: 200, 1223: 204}, qn = Z.ajaxSettings.xhr();
  ...
  Z.ajaxSetup({
    ...
    return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(jn, "$1" + i) : t.jsonp !== !1 && (t.url += (pn.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
      ...
      e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Pn.push(i)), a && Z.isFunction(o) && o(a[0]), a = o = void 0
    }), "script") : void 0
  ...
  Z.offset = {
    ...
    Z.cssHooks[t] = w(Q.pixelPosition, function (e, n) {
      return n ? (n = x(e, t), Ut.test(n) ? Z(e).position()[t] + "px" : n) : void 0
    })
  ...
  function j(e, t) {
    ...
    } else t = e, e && (k(e) ? t = j(e, []) : w(e) ? t = new Date(e.getTime()) : E(e) ? t = new RegExp(e.source) : y(e) && (t = j(e, {})));
    return t
  }
  ...
  function ut(t) {
    ...
    try {
      ...
      xr("ngLocale", []).provider("$locale", rn)
    }
    xr("ng", ["ngLocale"], ["$provide", function (e) {
  ...
  function $t(e, t, n, r) {
    ...
    a && (v(t) ? o(i, function (t, n) {
      ...
      v(n) ? (Rr(e, t, i[t]), delete i[t]) : P(i[t] || [], n)
    }))
  }
  ...
  function yt(e, t) {
    ...
    if (i) {
      ...
      i.handle && (i.events.$destroy && i.handle({}, "$destroy"), $t(e)), delete Nr[r], e[qr] = n
    }
  }

  function bt(e, t, n) {
    var r = e[qr], i = Nr[r || -1];
    return $(n) ? (i || (e[qr] = r = lt(), i = Nr[r] = {}), void(i[t] = n)) : i && i[t]
  }
  ...
  function Pt(e) {
    ...
    function n(e, t) {
      if (it(e, "service"), (C(t) || k(t)) && (t = x.instantiate(t)), !t.$get)throw Jr("pget", "Provider '{0}' must define $get factory method.", e);
      return $[e + d] = t
    }
    ...
    function c(e) {
      ...
      return o(e, function (e) {
        if (!v.get(e)) {
          v.put(e, !0);
          try {
            if (b(e))for (t = xr(e), a = a.concat(c(t.requires)).concat(t._runBlocks), n = t._invokeQueue, r = 0, i = n.length; i > r; r++) {
              var o = n[r], s = x.get(o[0]);
              s[o[1]].apply(s, o[2])
            } else C(e) ? a.push(x.invoke(e)) : k(e) ? a.push(x.invoke(e)) : rt(e, "module")
          } catch (u) {
    ...
    function p(e, t) {
      ...
      return {
        invoke: r, instantiate: i, get: n, annotate: qt, has: function (t) {
    ...
    }, x = $.$injector = p($, function () {
      throw Jr("unpr", "Unknown provider: {0}", g.join(" <- "))
    }), w = {}, E = w.$injector = p(w, function (e) {
      var t = x.get(e + d);
  ...
  function Vt(e, r) {
    ...
    this.directive = function f(t, n) {
    ...
    }, this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (e, r, u, f, h, v, $, x, w, E, T, S) {
      function D(e, t, n, r, i) {
      ...
      function N(e, t, n, r, i) {
        ...
        switch (u) {
          case 1:
            F(t, Ut(wr(e).toLowerCase()), "E", r, i);
            for (var p, f, d, h, g, m = e.attributes, v = 0, $ = m && m.length; $ > v; v++) {
              var y = !1, x = !1;
              if (p = m[v], !$r || $r >= 8 || p.specified) {
                f = p.name, h = Ut(f), it.test(h) && (f = et(h.substr(6), "-"));
                var w = h.replace(/(Start|End)$/, "");
                h === w + "Start" && (y = f, x = f.substr(0, f.length - 5) + "end", f = f.substr(0, f.length - 6)), d = Ut(f.toLowerCase()), c[d] = f, n[d] = g = Ar(p.value), At(e, d) && (n[d] = !0), G(e, t, g, d), F(t, d, "A", r, i, y, x)
              }
            }
      ...
      function j(e, i, a, s, l, c, p, f, d) {
        function h(e, t, n, r) {
          e && (n && (e = P(e, n, r)), e.require = w.require, (F === w || w.$$isolateScope) && (e = K(e, {isolateScope: !0})), p.push(e)), t && (n && (t = P(t, n, r)), t.require = w.require, (F === w || w.$$isolateScope) && (t = K(t, {isolateScope: !0})), f.push(t))
        }
        ...
        function m(e, t, s, l, c) {
          ...
          for (C = c && d, j && o(j, function (e) {
            ...
            w = e.controller, "@" == w && (w = h[e.name]), n = $(w, r), E[e.name] = n, X || m.data("$" + e.name + "Controller", n), e.controllerAs && (r.$scope[e.controllerAs] = n)
          }), y = 0, b = p.length; b > y; y++)try {
            x = p[y], x(x.isolateScope ? k : t, m, h, x.require && g(x.require, m, E), C)
          } catch (D) {
            u(D, z(m))
          }
          var M = t;
          for (F && (F.template || null === F.templateUrl) && (M = k), e && e(M, s.childNodes, n, c), y = f.length - 1; y >= 0; y--)try {
            x = f[y], x(x.isolateScope ? k : t, m, h, x.require && g(x.require, m, E), C)
          } catch (D) {
            u(D, z(m))
          }
        }
        ...
        d = d || {};
        for (var x, w, E, T, S, M, O = -Number.MAX_VALUE, j = d.controllerDirectives, F = d.newIsolateScopeDirective, V = d.templateDirective, B = d.nonTlbTranscludeDirective, Y = !1, X = d.hasElementTranscludeDirective, G = a.$$element = yr(i), Z = c, et = s, tt = 0, nt = e.length; nt > tt; tt++) {
          w = e[tt];
          var it = w.$$start, ot = w.$$end;
          if (it && (G = q(i, it, ot)), T = n, O > w.priority)break;
          if ((M = w.scope) && (x = x || w, w.templateUrl || (W("new/isolated scope", F, w, G), y(M) && (F = w))), E = w.name, !w.templateUrl && w.controller && (M = w.controller, j = j || {}, W("'" + E + "' controller", j[E], w, G), j[E] = w), (M = w.transclude) && (Y = !0, w.$$tlb || (W("transclusion", B, w, G), B = w), "element" == M ? (X = !0, O = w.priority, T = q(i, it, ot), G = a.$$element = yr(t.createComment(" " + E + ": " + a[E] + " ")), i = G[0], Q(l, yr(I(T)), i), et = D(T, s, O, Z && Z.name, {nonTlbTranscludeDirective: B})) : (T = yr(mt(i)).contents(), G.empty(), et = D(T, s))), w.template)if (W("template", V, w, G), V = w, M = C(w.template) ? w.template(G, a) : w.template, M = rt(M), w.replace) {
            if (Z = w, T = ft(M) ? [] : yr(M), i = T[0], 1 != T.length || 1 !== i.nodeType)throw ti("tplrt", "Template for directive '{0}' must have exactly one root element. {1}", E, "");
            Q(l, G, i);
            var at = {$attr: {}}, st = N(i, [], at), ut = e.splice(tt + 1, e.length - (tt + 1));
            F && L(st), e = e.concat(st).concat(ut), U(a, at), nt = e.length
          } else G.html(M);
          if (w.templateUrl)W("template", V, w, G), V = w, w.replace && (Z = w), m = _(e.splice(tt, e.length - tt), G, a, l, et, p, f, {
            controllerDirectives: j,
            newIsolateScopeDirective: F,
            templateDirective: V,
            nonTlbTranscludeDirective: B
          }), nt = e.length; else if (w.compile)try {
            S = w.compile(G, a, et), C(S) ? h(null, S, it, ot) : S && h(S.pre, S.post, it, ot)
          } catch (lt) {
            u(lt, z(G))
          }
          w.terminal && (m.terminal = !0, O = Math.max(O, w.priority))
        }
        return m.scope = x && x.scope === !0, m.transclude = Y && et, d.hasElementTranscludeDirective = X, m
      }
      ...
      function _(e, t, n, r, i, a, s, u) {
        ...
        return t.empty(), f.get(E.getTrustedResourceUrl($), {cache: h}).success(function (p) {
          ...
          if (p = rt(p), m.replace) {
            ...
            h = {$attr: {}}, Q(r, t, f);
            var w = N(f, [], h);
            y(m.scope) && L(w), e = w.concat(e), U(n, h)
          } else f = g, t.html(p);
          for (e.unshift(v), l = j(e, f, n, i, t, m, a, s, u), o(r, function (e, n) {
            ...
            x = l.transclude ? O(k, l.transclude) : T, l(c, k, S, r, x)
          }
          d = null
      ...
      function G(e, t, n, i) {
        var o = r(n, !0);
        if (o) {
          if ("multiple" === i && "SELECT" === wr(e))throw ti("selmulti", "Binding to the 'multiple' attribute is not supported. Element: {0}", z(e));
          t.push({
      ...
      J.prototype = {
        $normalize: Ut, $addClass: function (e) {
          ...
          s && (this.$$element.prop(e, t), i = s), this[e] = t, i ? this.$attr[e] = i : (i = this.$attr[e], i || (this.$attr[e] = i = et(e, "-"))), a = wr(this.$$element), ("A" === a && "href" === e || "IMG" === a && "src" === e) && (this[e] = t = S(t, "src" === e)), r !== !1 && (null === t || t === n ? this.$$element.removeAttr(i) : this.$$element.attr(i, t));
  ...
  function Kt() {
    ...
    this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (e, t, r, i, c, f) {
      ...
      function m(t, n, r) {
        ...
        function u() {
          var e = q(d.pendingRequests, t);
          -1 !== e && d.pendingRequests.splice(e, 1)
        }

        var l, p, f = c.defer(), h = f.promise, g = x(t.url, t.params);
        if (d.pendingRequests.push(t), h.then(u, u), (t.cache || a.cache) && t.cache !== !1 && "GET" == t.method && (l = y(t.cache) ? t.cache : y(a.cache) ? a.cache : w), l)if (p = l.get(g), $(p)) {
  ...
  function en(e, t, n, r, i) {
    ...
    return function (i, u, l, c, p, f, d, g) {
      ...
      function v(t, r, i, o, a) {
        C && n.cancel(C), x = w = null, 0 === r && (r = i ? 200 : "file" == Fn(u).protocol ? 404 : 0), r = 1223 === r ? 204 : r, a = a || "", t(r, i, o, a), e.$$completeOutstandingRequest(h)
      }
      ...
      if (e.$$incOutstandingRequestCount(), u = u || e.url(), "jsonp" == dr(i)) {
        ...
        var x = a(u.replace("JSON_CALLBACK", "angular.callbacks." + b), function () {
          r[b].data ? v(c, 200, r[b].data) : v(c, y || -2), r[b] = Sr.noop
        })
      } else {
        var w = t(i);
        if (w.open(i, u, !0), o(p, function (e, t) {
            $(e) && w.setRequestHeader(t, e)
          }), w.onreadystatechange = function () {
            if (w && 4 == w.readyState) {
              var e = null, t = null;
              y !== s && (e = w.getAllResponseHeaders(), t = "response"in w ? w.response : w.responseText), v(c, y || w.status, t, e, w.statusText || "")
            }
          }, d && (w.withCredentials = !0), g)try {
          w.responseType = g
        } catch (k) {
          if ("json" !== g)throw k
        }
  ...
  function En(e, t, r) {
    ...
    if (t.unwrapPromises || 1 !== s)if (t.unwrapPromises || 2 !== s)if (t.csp)i = 6 > s ? wn(a[0], a[1], a[2], a[3], a[4], r, t) : function (e, i) {
      var o, u = 0;
      do o = wn(a[u++], a[u++], a[u++], a[u++], a[u++], r, t)(e, i), i = n, e = o; while (s > u);
      return o
    }; else {
      var u = "var p;\n";
      o(a, function (e, n) {
    ...
    this.digestTtl = function (t) {
      ...
      c.prototype = {
        constructor: c, $new: function (e) {
          ...
          var r, i, o, s, u, l, c, d, h, g, v, $ = this.$$asyncQueue, y = this.$$postDigestQueue, b = e, x = this, w = [];
          p("$digest"), n = null;
          do {
            for (l = !1, d = x; $.length;) {
              try {
            ...
            e:do {
              if (s = d.$$watchers)for (u = s.length; u--;)try {
                ...
                } else l = !0, n = r, r.last = r.eq ? j(i) : i, r.fn(i, o === m ? i : o, d), 5 > b && (h = 4 - b, w[h] || (w[h] = []), g = C(r.exp) ? "fn: " + (r.exp.name || r.exp.toString()) : r.exp, g += "; newVal: " + _(i) + "; oldVal: " + _(o), w[h].push(g))
              } catch (k) {
                f(), a(k)
              }
              if (!(c = d.$$childHead || d !== x && d.$$nextSibling))for (; d !== x && !(c = d.$$nextSibling);)d = d.$parent
            } while (d = c);
            if ((l || $.length) && !b--)throw f(), t("infdig", "{0} $digest() iterations reached. Aborting!\nWatchers fired in the last 5 iterations: {1}", e, _(w))
          } while (l || $.length);
          for (f(); y.length;)try {
            y.shift()()
          } catch (k) {
  ...
  function Jn(e) {
    ...
    return function (n, r) {
      var i, a, s = "", u = [];
      if (r = r || "mediumDate", r = e.DATETIME_FORMATS[r] || r, b(n) && (n = wi.test(n) ? f(n) : t(n)), x(n) && (n = new Date(n)), !w(n))return n;
      for (; r;)a = xi.exec(r), a ? (u = F(u, a, 1), r = u.pop()) : (u.push(r), r = null);
  ...
  function sr(e, t, r, i, o, a) {
    if (ar(e, t, r, i, o, a), i.$parsers.push(function (e) {
        var t = i.$isEmpty(e);
        return t || qi.test(e) ? (i.$setValidity("number", !0), "" === e ? null : t ? e : parseFloat(e)) : (i.$setValidity("number", !1), n)
  ...
  var $r, yr, br, xr, wr, kr = [].slice, Cr = [].push, Er = Object.prototype.toString, Tr = r("ng"), Sr = (e.angular, e.angular || (e.angular = {})), Dr = ["0", "0", "0"];
  ...
  }, Nr = gt.cache = {}, qr = gt.expando = "ng-" + (new Date).getTime(), Pr = 1, jr = e.document.addEventListener ? function (e, t, n) {
  ...
  o("input,select,option,textarea,button,form,details".split(","), function (e) {
    ...
    data: xt, inheritedData: St, scope: function (e) {
    ...
    gt.prototype[t] = function (t, r) {
      var i, o;
      if (e !== Dt && (2 == e.length && e !== wt && e !== Tt ? t : r) === n) {
        if (y(t)) {
          for (i = 0; i < this.length; i++)if (e === xt)e(this[i], t); else for (o in t)e(this[i], o, t[o]);
          return this
        }
    ...
    constructor: di, parse: function (e, t) {
      ...
      return p(function (t, n, i) {
        ...
        assign: function (r, i, o) {
          return xn(e(r, o), n, i, t.text, t.options)
        }
      })
  ...
  var yi = ".", bi = {
    ...
    a: Kn,
    Z: Qn
  }, xi = /((?:[^yMdHhmsaZE']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z))(.*)/, wi = /^\-?\d+$/;
  Jn.$inject = ["$locale"];
  var ki = m(dr), Ci = m(gr);
  tr.$inject = ["$parse"];
  var Ei = m({
  ...
  var Di = function (e) {
        ...
        name: "form", restrict: e ? "EAC" : "E", controller: rr, compile: function () {
          return {
            pre: function (e, r, i, o) {
              ...
              u && xn(e, u, o, u), s && r.on("$destroy", function () {
                s.$removeControl(o), u && xn(e, u, n, u), p(o, Si)
              })
            }
          }
        }
  ...
  }, Ai = Di(), Mi = Di(!0), Oi = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Ni = /^[a-z0-9!#$%&'*+/=?^_`{|}~.-]+@[a-z0-9-]+(\.[a-z0-9-]+)*$/i, qi = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Pi = {
    text: ar,
    number: sr,
    url: ur,
    email: lr,
    ...
    return {
      restrict: "E", require: "?ngModel", link: function (n, r, i, o) {
        o && (Pi[dr(i.type)] || Pi.text)(n, r, i, o, t, e)
      }
    }
  ...
  var no = ["$animate", function (e) {
    ...
    return {
      transclude: "element", priority: 1e3, terminal: !0, $$tlb: !0, link: function (r, c, p, f, d) {
        var h, g, m, v, $, y, b, x, w, k = p.ngRepeat, C = k.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), E = {$id: Ot};
        ...
        if (y = C[1], b = C[2], h = C[3], h ? (g = e(h), m = function (e, t, n) {
            return w && (E[w] = e), E[x] = t, E.$index = n, g(r, E)
          }) : (v = function (e, t) {
            return Ot(t)
          }, $ = function (e) {
            return e
        ...
        r.$watchCollection(b, function (e) {
          var p, f, h, g, y, b, C, E, S, D, A, M, O = c[0], N = {}, q = [];
          if (i(e))D = e, S = m || v; else {
            S = m || $, D = [];
            for (b in e)e.hasOwnProperty(b) && "$" != b.charAt(0) && D.push(b);
            D.sort()
          }
          for (g = D.length, f = q.length = D.length, p = 0; f > p; p++)if (b = e === D ? p : D[p], C = e[b], E = S(b, C, p), it(E, "`track by` id"), T.hasOwnProperty(E))A = T[E], delete T[E], N[E] = A, q[p] = A; else {
            if (N.hasOwnProperty(E))throw o(q, function (e) {
              e && e.scope && (T[e.id] = e)
          ...
          for (p = 0, f = D.length; f > p; p++) {
            if (b = e === D ? p : D[p], C = e[b], A = q[p], q[p - 1] && (O = s(q[p - 1])), A.scope) {
              y = A.scope, h = O;
              do h = h.nextSibling; while (h && h[u]);
              a(A) != h && n.move(at(A.clone), null, yr(O)), O = s(A)
            } else y = r.$new();
            y[x] = C, w && (y[w] = b), y.$index = p, y.$first = 0 === p, y.$last = p === g - 1, y.$middle = !(y.$first || y.$last), y.$odd = !(y.$even = 0 === (1 & p)), A.scope || d(y, function (e) {
    ...
    return {
      ...
      link: function (s, u, l, c) {
        ...
        function d(t, o, s) {
          function u() {
            var e, n, r, i, u, l, m, b, T, S, D, A, M, O, N, q = {"": []}, P = [""], j = s.$modelValue, R = g(t) || [], H = f ? a(R) : R, L = {}, F = !1;
            if (y)if (v && k(j)) {
              F = new Nt([]);
            ...
            for (D = 0; T = H.length, T > D; D++) {
              ...
              if (L[p] = R[m], e = d(t, L) || "", (n = q[e]) || (n = q[e] = [], P.push(e)), y)A = $(F.remove(v ? v(t, L) : h(t, L))); else {
                if (v) {
                  var V = {};
                  V[p] = j, A = v(t, V) === v(t, L)
                } else A = j === h(t, L);
            ...
            for (y || (x || null === j ? q[""].unshift({id: "", label: "", selected: !F}) : F || q[""].unshift({
              id: "?",
              label: "",
              selected: !0
            })), S = 0, b = P.length; b > S; S++) {
              for (e = P[S], n = q[e], E.length <= S ? (i = {
                element: C.clone().attr("label", e),
                label: n.label
              }, u = [i], E.push(u), o.append(i.element)) : (u = E[S], i = u[0], i.label != e && i.element.attr("label", i.label = e)), M = null, D = 0, T = n.length; T > D; D++)r = n[D], (l = u[D + 1]) ? (M = l.element, l.label !== r.label && M.text(l.label = r.label), l.id !== r.id && M.val(l.id = r.id), l.selected !== r.selected && M.prop("selected", l.selected = r.selected)) : ("" === r.id && x ? O = x : (O = w.clone()).val(r.id).attr("selected", r.selected).text(r.label), u.push(l = {
                element: O,
                label: r.label,
                id: r.id,
                selected: r.selected
        ...
        if (c[1]) {
          for (var h, g = c[0], m = c[1], y = l.multiple, b = l.ngOptions, x = !1, w = yr(t.createElement("option")), C = yr(t.createElement("optgroup")), E = w.clone(), T = 0, S = u.children(), D = S.length; D > T; T++)if ("" === S[T].value) {
            h = x = S.eq(T);
            break
          }
          g.init(m, x, E), y && (m.$isEmpty = function (e) {
            return !e || 0 === e.length
          }), b ? d(s, u, m) : y ? f(s, u, m) : p(s, u, m, g)
        }
      }
    }
  }], xo = ["$interpolate", function (e) {
    ...
    function c(s, u, v) {
      ...
      return v = h({}, p, v), d(v, function (i, s) {
        ...
        b[s] = function (s, l, c, p) {
          ...
          }), u && (S.data = v), x.setUrlParams(S, h({}, $(v, i.params || {}), C), i.url);
  ...
  function o(e, n) {
    function r(e, r, o, s) {
      ...
      w[r] && $.last() == r && i("", r), s = y[r] || !!s, s || $.push(r);
      var u = {};
    ...
    for ($.last = function () {
      ...
      if (s = !0, $.last() && E[$.last()])e = e.replace(new RegExp("(.*)<\\s*\\/\\s*" + $.last() + "[^>]*>", "i"), function (e, t) {
        ...
        o = e.indexOf("<");
        var x = 0 > o ? e : e.substring(0, o);
        e = 0 > o ? "" : e.substring(o), n.chars && n.chars(a(x))
      }
  ...
  var l = t.$$minErr("$sanitize"), c = /^<\s*([\w:-]+)((?:\s+[\w:-]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)\s*>/, p = /^<\s*\/\s*([\w:-]+)[^>]*>/, f = /([\w:-]+)(?:\s*=\s*(?:(?:"((?:[^"])*)")|(?:'((?:[^'])*)')|([^>\s]+)))?/g, d = /^</, h = /^<\s*\//, g = /<!--(.*?)-->/g, m = /<!DOCTYPE([^>]*?)>/i, v = /<!\[CDATA\[(.*?)]]>/g, $ = /([^\#-~| |!])/g, y = i("area,br,col,hr,img,wbr"), b = i("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"), x = i("rp,rt"), w = t.extend({}, x, b), k = t.extend({}, b, i("address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,script,section,table,ul")), C = t.extend({}, x, i("a,abbr,acronym,b,bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,q,ruby,rp,rt,s,samp,small,span,strike,strong,sub,sup,time,tt,u,var")), E = i("script,style"), T = t.extend({}, y, k, C, w), S = i("background,cite,href,longdesc,src,usemap"), D = t.extend({}, S, i("abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,color,cols,colspan,compact,coords,dir,face,headers,height,hreflang,hspace,ismap,lang,language,nohref,nowrap,rel,rev,rows,rowspan,rules,scope,scrolling,shape,size,span,start,summary,target,title,type,valign,value,vspace,width")), A = document.createElement("pre"), M = /^(\s*)([\s\S]*?)(\s*)$/;
      ...
      return {
        restrict: "EA", scope: !0, compile: function () {
          ...
          return function (t, n, r) {
            ...
            function c() {
              (!E || t.$eval(r[f + "Enable"])) && (t.tt_popupDelay ? w || (w = a(m, t.tt_popupDelay, !1), w.then(function (e) {
                e()
              })) : m()())
            }
            ...
            function m() {
              return w = null, x && (a.cancel(x), x = null), t.tt_content ? ($(), b.css({
                top: 0,
                left: 0,
                display: "block"
            ...
            function v() {
              t.tt_isOpen = !1, a.cancel(w), w = null, t.tt_animation ? x || (x = a(y, 500)) : y()
            }
            ...
            function y() {
              x = null, b && (b.remove(), b = null)
            }

            var b, x, w, k = angular.isDefined(g.appendToBody) ? g.appendToBody : !1, C = h(void 0), E = angular.isDefined(r[f + "Enable"]), T = function () {
  ...
  return {
    require: "ngModel", link: function (u, l, c, p) {
      ...
      var S = function (e) {
        var t = {$viewValue: e};
        m(u, !0), n.when(x.source(u, t)).then(function (n) {
          var r = e === p.$viewValue;
          if (r && f)if (n.length > 0) {
            w.activeIdx = 0, w.matches.length = 0;
            for (var i = 0; i < n.length; i++)t[x.itemName] = n[i], w.matches.push({
              id: T(i),
              label: x.viewMapper(w, t),
              model: n[i]
            });
            w.query = e, w.position = y ? o.offset(l) : o.position(l), w.position.top = w.position.top + l.prop("offsetHeight"), l.attr("aria-expanded", !0)
          } else E();
          r && m(u, !1)
        }, function () {
          E(), m(u, !1)
      ...
      p.$parsers.unshift(function (e) {
        ...
        var t, n, i = {};
        i[x.itemName] = n = w.matches[e].model, t = x.modelMapper(u, i), b(u, t), p.$setValidity("editable", !0), v(u, {
          $item: n,
          $model: t,
        ...
        0 !== w.matches.length && -1 !== s.indexOf(e.which) && (e.preventDefault(), 40 === e.which ? (w.activeIdx = (w.activeIdx + 1) % w.matches.length, w.$digest()) : 38 === e.which ? (w.activeIdx = (w.activeIdx ? w.activeIdx : w.matches.length) - 1, w.$digest()) : 13 === e.which || 9 === e.which ? w.$apply(function () {
...
}), define("camunda-cockpit-ui-deps", function () {
});
