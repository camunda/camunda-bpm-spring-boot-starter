...
public class CamundaBpmVersionTest {
  ...
  private static final String CURRENT_VERSION = "7.7.0";
  ...
  public void current_version() {
    ...
    assertThat(version.get()).isEqualTo(CURRENT_VERSION);
    ...
    assertThat(source.getProperty(key(CamundaBpmVersion.VERSION))).isEqualTo(CURRENT_VERSION);
    assertThat(source.getProperty(key(CamundaBpmVersion.FORMATTED_VERSION))).isEqualTo("(v" + CURRENT_VERSION + ")");
